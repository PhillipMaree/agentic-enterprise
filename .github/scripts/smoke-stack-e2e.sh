...
kubectl -n "$NAMESPACE" port-forward deploy/enterprise-platform-litellm        4000:4000 >/tmp/pf-litellm.log 2>&1 &
kubectl -n "$NAMESPACE" port-forward svc/enterprise-platform-prometheus-server 9090:80   >/tmp/pf-prom.log 2>&1 &
