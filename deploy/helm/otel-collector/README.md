...
helm install platform-otel-collector deploy/helm/otel-collector \
...
- `platform-otel-collector:4317` (OTLP gRPC)
- `platform-otel-collector:4318` (OTLP HTTP)

## Uninstall

```bash
helm uninstall platform-otel-collector -n agentic-platform
```
